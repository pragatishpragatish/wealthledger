-- ============================================================
-- Migration 011: Brokerage & Charges expense category
-- For lump-sum demat / broker wallet fee deductions.
...
CROSS JOIN (
  VALUES
    ('Brokerage & Charges', 'expense', 'receipt', '#57534E', 18)
...
BEGIN
  ...
  INSERT INTO public.categories (user_id, name, kind, icon, color, is_system, sort_order) VALUES
    ...
    (NEW.id, 'Brokerage & Charges', 'expense', 'receipt', '#57534E', TRUE, 18);
